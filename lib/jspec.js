...
var Jspec = {
	...
	matchers : {
		eql   : function(expected, got) { return got == expected },
		equal : function(expected, got) { return got === expected }
	},
	...
	Matcher : function (name, matcher, expected, got, negate) {
		...
		if (typeof matcher == 'function') matcher = { match : matcher }
	...
	runSuite : function(suite) {
		this.each(suite.specs, function(i, spec) {
	      ...
	      throw "Error in spec '" + spec.description + "': " + e
	    }
