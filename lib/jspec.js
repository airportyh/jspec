...
var Jspec = {
  ...
  matchers : {
    ...
    include         : { match : function(expected, actual) {
      ...
      switch (actual.constructor) {
        ...
        case Array:
          Jspec.each(actual, function(i, value){
            if (value == expected) status = true
          })
          break
      }
  ...
  Matcher : function (name, matcher, expected, actual, negate) {
    ...
    this.match = function() {
      ...
      return matcher.match.call(actual, expected, actual.valueOf())
    }
  ...
  parse : function(input) {
    var describing = false, specing = false, capturing = false
