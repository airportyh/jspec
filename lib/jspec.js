...
var JSpec = {
  ...
  addMatchers : function(matchers) {
    this.each(matchers, function(name, body){
      this.addMatcher(name, body, true).addMatcher(name, body, false)
    })
    return this
  },
  
  /**
   * Add a matcher. Do not invoke this directly, use addMatchers.
   *
   * @param  {string} name
  ...
  addMatcher : function(name, body, negate) {
    Object.prototype['should_' + (negate ? '_not' : '') + name] = function(other) {
