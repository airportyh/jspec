...
catch(e){return true}}}},Context:function(){},Matcher:function(name,matcher,expected,actual,negate){var self=this
...
markup+='</div></div>'
report.innerHTML=markup},Suite:function(description){this.specs=[],this.hooks={},this.description=description,this.ran=false
