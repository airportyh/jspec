...
var JSpec={version:'0.3.0',main:this,suites:{},stats:{specs:0,assertions:0,failures:0,passes:0},matchers:{eql:"==",be:"alias eql",equal:"===",be_greater_than:">",be_less_than:"<",be_at_least:">=",be_at_most:"<=",be_a:"actual.constructor == expected",be_an:"alias be_a",be_empty:"actual.length == 0",be_true:"actual == true",be_false:"actual == false",be_type:"typeof actual == expected",match:"typeof actual == 'string' ? actual.match(expected) : false",have_length_of:"actual.length == expected",respond_to:"typeof actual[expected] == 'function'",include:{match:function(expected,actual){if(actual.constructor==String)return actual.match(expected)
